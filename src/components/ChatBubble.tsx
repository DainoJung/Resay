            ...
            <div className="flex items-start gap-2">
              <div className="flex-1 space-y-2">
                <p className={`text-[15px] font-medium leading-relaxed ${
                  feedback.is_perfect ? "text-gray-800" : "text-white"
                }`}>
                  {feedback.paraphrase}
                </p>
                <p className={`text-[13px] leading-relaxed ${
                  feedback.is_perfect ? "text-gray-500" : "text-gray-400"
                }`}>
              ...
              {onSaveSentence && (
                <button
                  ...
                  className={`flex-shrink-0 mt-0.5 transition-colors ${
                    isSaved ? "text-emerald-400" : (feedback.is_perfect ? "text-gray-400 hover:text-emerald-500" : "text-gray-500 hover:text-emerald-400")
                  }`}
                >
                  <svg
                    className="w-5 h-5"
